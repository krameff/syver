	...
	testCases := map[string]struct {
		...
		"all-success-single-type": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="pass",type="command"} 20`,
				`goss_tests_outcomes_total{outcome="pass",type="command"} 2`,
				`syver_tests_outcomes_total{outcome="pass",type="command"} 2`,
				`goss_tests_run_duration_milliseconds{outcome="pass"}`,
				`syver_tests_run_duration_milliseconds{outcome="pass"}`,
				`goss_tests_run_outcomes_total{outcome="pass"} 1`,
				`syver_tests_run_outcomes_total{outcome="pass"} 1`,
			},
		},
		"all-skip-single-type": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="skip",type="command"} 20`,
				`goss_tests_outcomes_total{outcome="skip",type="command"} 2`,
				`syver_tests_outcomes_total{outcome="skip",type="command"} 2`,
				`goss_tests_run_duration_milliseconds{outcome="skip"}`,
				`syver_tests_run_duration_milliseconds{outcome="skip"}`,
				`goss_tests_run_outcomes_total{outcome="skip"} 1`,
				`syver_tests_run_outcomes_total{outcome="skip"} 1`,
			},
		},
		"all-fail-single-type": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="fail",type="command"} 20`,
				`goss_tests_outcomes_total{outcome="fail",type="command"} 2`,
				`syver_tests_outcomes_total{outcome="fail",type="command"} 2`,
				`goss_tests_run_duration_milliseconds{outcome="fail"}`,
				`syver_tests_run_duration_milliseconds{outcome="fail"}`,
				`goss_tests_run_outcomes_total{outcome="fail"} 1`,
				`syver_tests_run_outcomes_total{outcome="fail"} 1`,
			},
		},
		"all-unknown-single-type": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="unknown",type="command"} 20`,
				`goss_tests_outcomes_total{outcome="unknown",type="command"} 2`,
				`syver_tests_outcomes_total{outcome="unknown",type="command"} 2`,
				`goss_tests_run_duration_milliseconds{outcome="unknown"}`,
				`syver_tests_run_duration_milliseconds{outcome="unknown"}`,
				`goss_tests_run_outcomes_total{outcome="unknown"} 1`,
				`syver_tests_run_outcomes_total{outcome="unknown"} 1`,
			},
		},
		"all-success-multiple-types": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="pass",type="command"} 10`,
				`goss_tests_outcomes_duration_milliseconds{outcome="pass",type="file"} 10`,
				`syver_tests_outcomes_duration_milliseconds{outcome="pass",type="file"} 10`,
				`goss_tests_outcomes_total{outcome="pass",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="pass",type="command"} 1`,
				`goss_tests_outcomes_total{outcome="pass",type="file"} 1`,
				`syver_tests_outcomes_total{outcome="pass",type="file"} 1`,
				`goss_tests_run_duration_milliseconds{outcome="pass"}`,
				`syver_tests_run_duration_milliseconds{outcome="pass"}`,
				`goss_tests_run_outcomes_total{outcome="pass"} 1`,
				`syver_tests_run_outcomes_total{outcome="pass"} 1`,
		...
		"various-results-single-type": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="skip",type="command"} 10`,
				`goss_tests_outcomes_duration_milliseconds{outcome="fail",type="command"} 10`,
				`syver_tests_outcomes_duration_milliseconds{outcome="fail",type="command"} 10`,
				`goss_tests_outcomes_duration_milliseconds{outcome="unknown",type="command"} 10`,
				`syver_tests_outcomes_duration_milliseconds{outcome="unknown",type="command"} 10`,
				`goss_tests_outcomes_total{outcome="pass",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="pass",type="command"} 1`,
				`goss_tests_outcomes_total{outcome="skip",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="skip",type="command"} 1`,
				`goss_tests_outcomes_total{outcome="fail",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="fail",type="command"} 1`,
				`goss_tests_outcomes_total{outcome="unknown",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="unknown",type="command"} 1`,
				`goss_tests_run_duration_milliseconds{outcome="fail"}`,
				`syver_tests_run_duration_milliseconds{outcome="fail"}`,
				`goss_tests_run_outcomes_total{outcome="fail"} 1`,
				`syver_tests_run_outcomes_total{outcome="fail"} 1`,
		...
		"various-results-multiple-types": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="skip",type="file"} 10`,
				`goss_tests_outcomes_duration_milliseconds{outcome="fail",type="command"} 10`,
				`syver_tests_outcomes_duration_milliseconds{outcome="fail",type="command"} 10`,
				`goss_tests_outcomes_duration_milliseconds{outcome="unknown",type="file"} 10`,
				`syver_tests_outcomes_duration_milliseconds{outcome="unknown",type="file"} 10`,
				`goss_tests_outcomes_total{outcome="pass",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="pass",type="command"} 1`,
				`goss_tests_outcomes_total{outcome="skip",type="file"} 1`,
				`syver_tests_outcomes_total{outcome="skip",type="file"} 1`,
				`goss_tests_outcomes_total{outcome="fail",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="fail",type="command"} 1`,
				`goss_tests_outcomes_total{outcome="unknown",type="file"} 1`,
				`syver_tests_outcomes_total{outcome="unknown",type="file"} 1`,
				`goss_tests_run_duration_milliseconds{outcome="fail"}`,
				`syver_tests_run_duration_milliseconds{outcome="fail"}`,
				`goss_tests_run_outcomes_total{outcome="fail"} 1`,
				`syver_tests_run_outcomes_total{outcome="fail"} 1`,
		...
		"verbose": {
			...
			expectedMetrics: []string{
				...
				`syver_tests_outcomes_duration_milliseconds{outcome="pass",resource_id="some command here",type="command"} 10`,
				`goss_tests_outcomes_total{outcome="pass",resource_id="some command here",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="pass",resource_id="some command here",type="command"} 1`,
				`goss_tests_outcomes_duration_milliseconds{outcome="pass",resource_id="something else here",type="command"} 10`,
				`syver_tests_outcomes_duration_milliseconds{outcome="pass",resource_id="something else here",type="command"} 10`,
				`goss_tests_outcomes_total{outcome="pass",resource_id="something else here",type="command"} 1`,
				`syver_tests_outcomes_total{outcome="pass",resource_id="something else here",type="command"} 1`,
				`goss_tests_outcomes_duration_milliseconds{outcome="fail",resource_id="/path/to/file",type="file"} 10`,
				`syver_tests_outcomes_duration_milliseconds{outcome="fail",resource_id="/path/to/file",type="file"} 10`,
				`goss_tests_outcomes_total{outcome="fail",resource_id="/path/to/file",type="file"} 1`,
				`syver_tests_outcomes_total{outcome="fail",resource_id="/path/to/file",type="file"} 1`,
				`goss_tests_run_duration_milliseconds{outcome="fail"}`,
				`syver_tests_run_duration_milliseconds{outcome="fail"}`,
				`goss_tests_run_outcomes_total{outcome="fail"} 1`,
				`syver_tests_run_outcomes_total{outcome="fail"} 1`,
